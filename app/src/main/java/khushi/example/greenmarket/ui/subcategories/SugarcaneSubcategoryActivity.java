...
public class SugarcaneSubcategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sugarcane_subcategory);
        ...
        items.add(new GridItem("Ganna", R.drawable.ganna));
        items.add(new GridItem("Gud", R.drawable.gud));
        items.add(new GridItem("Khaand", R.drawable.khaand));
        items.add(new GridItem("Cheeni", R.drawable.cheeni));
        items.add(new GridItem("Sirka", R.drawable.sirka));
        ...
        gridView.setOnItemClickListener((adapterView, view, position, id) -> {
            ...
            if (selectedItem != null && selectedItem.getName() != null) {
                ...
                String category = "Sugarcane";

                Log.d("SubcategoryClick", "Sending subcategory: " + subcategory);
                Log.d("SubcategoryClick", "Sending category: " + category);

                Intent intent = new Intent(SugarcaneSubcategoryActivity.this, StaticProductsActivity.class);
